...
class CreateCashRegisterReportsTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('cash_register_reports', function (Blueprint $table) {
            ...
            $table->decimal('cash_total', 12, 4)->default(0);
            $table->decimal('gift_card_total', 12, 4)->default(0);
            $table->decimal('credit_card_total', 12, 4)->default(0);
            $table->decimal('pos_terminal_total', 12, 4)->default(0);
            $table->decimal('change_total', 12, 4)->default(0);
            $table->decimal('cash_tax', 12, 4)->default(0);
            $table->decimal('gift_card_tax', 12, 4)->default(0);
            $table->decimal('credit_card_tax', 12, 4)->default(0);
            $table->decimal('pos_terminal_tax', 12, 4)->default(0);
            $table->integer('order_count')->default(0);
            $table->integer('order_product_count')->default(0);
            $table->integer('order_refund_count')->default(0);
            $table->decimal('order_refund_total', 12, 4)->default(0);
            $table->integer('order_complete_count')->default(0);
            $table->decimal('order_complete_total', 12, 4)->default(0);
