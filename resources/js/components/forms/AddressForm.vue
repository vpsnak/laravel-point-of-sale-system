	...
	<ValidationObserver v-slot="{ invalid }">
		<v-form @submit.prevent="submit">
			<v-row>
				...
				<v-col cols="4">
					<ValidationProvider rules="required|max:100" v-slot="{ errors, valid }" name="Location">
						<v-select
				...
				<v-col cols="4">
					<ValidationProvider rules="required|max:100" v-slot="{ errors, valid }" name="Location name">
						<v-text-field
