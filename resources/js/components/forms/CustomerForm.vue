<template>
      <v-card ref="form">
          <div class="text-center">
            <v-chip class="mb-n8 mx-auto"
      elevation="5"
      color="primary"
      label
    >
      <v-icon left>fas fa-user-astronaut</i></i> </v-icon>
     Customer Form 
    </v-chip>
    </div>
        <v-card-text>
...
<script>
  export default {
    data(){
      ...
      countries: [
       ...
       'Chad', 'Chile', 'China', 'Colombia', 'Congo', 'Cook Islands',
        'Costa Rica', 'Cote D Ivoire', 'Croatia', 'Cruise Ship', 
            ...
            'Greece', 'Greenland', 'Grenada', 'Guam', 'Guatemala',
             'Guernsey', 'Guinea', 'Guinea Bissau', 'Guyana', 'Haiti',
              ...
              'Indonesia', 'Iran', 'Iraq', 'Ireland', 'Isle of Man', 'Israel',
               ...
               'Kenya', 'Kuwait', 'Kyrgyz Republic', 'Laos', 'Latvia', 'Lebanon', 
               'Lesotho', 'Liberia', 'Libya', 'Liechtenstein', 'Lithuania', 'Luxembourg',
                'Macau', 'Macedonia', 'Madagascar', 'Malawi', 'Malaysia', 'Maldives', 'Mali',
                 'Malta', 'Mauritania', 'Mauritius', 'Mexico', 'Moldova', 'Monaco', 'Mongolia',
                  'Montenegro', 'Montserrat', 'Morocco', 'Mozambique', 'Namibia', 'Nepal',
                   ...
                   'Portugal', 'Puerto Rico', 'Qatar', 'Reunion', 'Romania', 'Russia', 'Rwanda',
                    'Saint Pierre &amp; Miquelon', 'Samoa', 'San Marino', 'Satellite', 'Saudi Arabia',
    ...
    methods: {
      lengthCheck () {
        this.errorMessages = this.company_name && !this.firstname
