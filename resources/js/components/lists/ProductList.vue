                        ...
                        >
                            <v-card-title class="secondary pa-0" @click.stop>
                                ...
                                <v-menu bottom left>
                                    ...
                                    <v-list>
                                        <v-list-item
                                            @click="viewProductDialog(product)"
                                        >
                                            <v-icon class="pr-2"
                                                >mdi-eye</v-icon
                                            >
                            ...
                            <v-card-actions>
                                <div class="d-flex flex-column">
                                    <v-chip
                                        small
                                        class="grey darken-1 mt-2 ml-1 elevation-12"
                                    >
                                        <span>SKU: {{ product.sku }}</span>
                                    </v-chip>
                                    <v-chip
                                        small
                                        class="secondary mt-2 ml-1 elevation-12"
                                    >
                                        <span
                                            >Price:
                                            {{
