        ...
        <v-row>
            <v-col cols="12">
                <v-card>
                    ...
                    <v-card-text>
                        <div class="subtitle-1">Company name: {{ cashRegister.created_by }}</div>
                        <div class="subtitle-1">Created at: {{ cashRegister.created_at }}</div>
                        <div class="subtitle-1">Updated at: {{ cashRegister.updated_at }}</div>
                    </v-card-text>
                </v-card>
            </v-col>
