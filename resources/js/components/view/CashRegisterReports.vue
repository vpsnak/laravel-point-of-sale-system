      ...
      <v-col cols="12" md="5">
        <v-card>
          ...
          <v-card-text>
            ...
            <div
              class="subtitle-1"
            >Total: {{ parseFloat(cashRegisterReportsData.total).toFixed(2) }} $</div>
          </v-card-text>
        </v-card>
      </v-col>
      <v-col cols="12" md="7">
      ...
      <v-col cols="12" md="5">
        <v-card>
          ...
          <v-card-text>
            ...
            <div
              class="subtitle-1"
            >Order product count: {{ cashRegisterReportsData.order_product_count}}</div>
            <div
              class="subtitle-1"
            >Order refund count: {{ cashRegisterReportsData.order_refund_count }}</div>
            <div
              class="subtitle-1"
            ...
            <div
              class="subtitle-1"
            >Order retail count: {{ cashRegisterReportsData.order_retail_count }}</div>
            <div
              class="subtitle-1"
